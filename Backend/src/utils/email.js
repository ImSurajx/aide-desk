...
You have been added as a customer on the ${companyName} support portal powered by AideDesk.
...
AideDesk Team
  ...
  <div style="font-family: Arial, sans-serif; background-color: #f0f4f8; padding: 30px;">
    <table align="center" width="620" cellpadding="0" cellspacing="0"
      ...
      <tr>
        <td style="padding: 32px 36px 0;">
          <p style="font-size: 16px; color: #374151; margin: 0 0 16px;">Hi <strong>${customerName}</strong>,</p>
          <p style="font-size: 15px; color: #6b7280; line-height: 1.6; margin: 0 0 24px;">
            <strong>${companyName}</strong> has set up an account for you on their support portal.
            Use the credentials below to log in and get in touch with their support team.
          </p>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding: 0 36px 28px;">
          <table width="100%" cellpadding="0" cellspacing="0"
            ...
            <tr>
              <td style="padding: 14px 18px; font-size: 14px; color: #166534; line-height: 1.6;">
                💡 <strong>Tip:</strong> After logging in, go to
                <a href="${changePasswordUrl}" style="color: #16a34a;">Profile → Change Password</a>
                to set a password only you know.
              </td>
            </tr>
          </table>
        </td>
        ...
        <td style="padding: 0 36px 28px;">
          <table width="100%" cellpadding="0" cellspacing="0"
            ...
            <tr>
              <td style="padding: 14px 18px; font-size: 13px; color: #92400e; line-height: 1.5;">
                ⚠️ <strong>Keep your credentials private.</strong>
                Do not share this email or your password with anyone.
              </td>
            </tr>
          </table>
        </td>
